---
title: "Agreement on polytomous outcomes in the situation of more than two raters"
author: "Iris Eekhout"
date: "`r Sys.Date()`"
...
# Specific agreement on polytomous outcomes in the situation of more than two raters
...
```{r}
load("~/Github/Agree/data/breast.rda")
...
agreement(table1)
CIagreement(agreement(table),m=4,n=nrow(data1))
...
### Specific agreement
The specific agreement for polytomous data, can be defined in two ways: the agreement of for one category versus not that category (e.g. satisfied versus all other categories) or the agreement for one category versus any other (e.g. satistfied versus ) 

```{r}
specific.agreement2(table1)
...
load("~/Github/Agree/data/diagnoses.rda")
...
specific.agreement2(table2)

CIagreement(agreement(table2),m=5,n=nrow(data2))
